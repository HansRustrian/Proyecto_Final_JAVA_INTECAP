...
public class form_usuario extends Administrador {

    JFrame crear_frame = new JFrame();
    Object usuarios[][] = new Object[50][9];
    JPanel panel2 = new JPanel();
    JButton b1;
    JButton b2;

    public void agregar_usuario(String usuario) throws ClassNotFoundException {

        crear_frame.setSize(900, 650);
        crear_frame.setLocationRelativeTo(null);
        crear_frame.setMaximumSize(new Dimension(1000, 1000));
        crear_frame.setVisible(true);
        panel2.setBackground(Color.lightGray);
        panel2.setLayout(null);
        crear_frame.add(panel2);
        ...
        text5.setBounds(670, 330, 200, 20);
        ...
        text6.setBounds(160, 445, 250, 20);
